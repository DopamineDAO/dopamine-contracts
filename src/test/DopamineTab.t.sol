...
contract DopamineTabTest is Test, IDopamineTabEvents {
    ...
    function testConstructor() public {
        ...
        new DopamineTab(ADMIN, IProxyRegistry(PROXY_REGISTRY), minDropSize - 1, DROP_DELAY, WHITELIST_SIZE, MAX_SUPPLY);
        ...
        new DopamineTab(ADMIN, IProxyRegistry(PROXY_REGISTRY), DROP_SIZE, maxDropDelay + 1, WHITELIST_SIZE, MAX_SUPPLY);
