...
import "../interfaces/IDopaminePass.sol";
...
/// @title Dopamine Pass Test Suites
contract DopaminePassTest is Test, IDopaminePassEvents {
    ...
    function setUp() public virtual {
        ...
        token = new DopaminePass(ADMIN, PROXY_REGISTRY, DROP_SIZE, DROP_DELAY, WHITELIST_SIZE, MAX_SUPPLY);
    ...
    function testConstructor() public {
        ...
        new DopaminePass(ADMIN, IProxyRegistry(PROXY_REGISTRY), minDropSize - 1, DROP_DELAY, WHITELIST_SIZE, MAX_SUPPLY);
        ...
        new DopaminePass(ADMIN, IProxyRegistry(PROXY_REGISTRY), DROP_SIZE, maxDropDelay + 1, WHITELIST_SIZE, MAX_SUPPLY);
