...
import "./errors.sol";
import { IDopaminePass } from "./interfaces/IDopaminePass.sol";
...
/// @notice DopaminePass holders are first-class members of the Dopamine DAO.
...
contract DopaminePass is ERC721Votable, IDopaminePass {
    ...
    constructor(
        ...
        uint256 maxSupply_
    ) ERC721Votable("DopaminePass", "DOPE", maxSupply_) {
		admin = msg.sender;
        minter = minter_;
